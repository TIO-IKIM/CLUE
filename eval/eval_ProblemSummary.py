...
def main():
    ...
    few_shot_chat = build_few_shot_examples(data[:args.num_few_shot_examples], sys_prompt, user_prompt_template, assistant_response_template, tokenizer, args.model_is_instruct)
